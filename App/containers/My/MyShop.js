...
import Myrelshop from '../../components/myRelShop/myrelshop';
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            merchantinfo: {
                relId: null,
                merchantId: null,//A商户
                priceMerchantId: null,//B商户
                merchantAgreeMark: null,//0是A不同意改价，1是A同意改价
                priceMerchantAgreeMark: null,//0是B不同意改价，1是B同意改价
                merchantDeleteMark: null,//0是A没有删除，1是A已经删除
                priceMerchantDeleteMark: null,//0是B没有删除，1是B已经删除
                note: null,
            }
        };
    }
                ...
                >
                    <View style={{height: 300, marginTop: 100,alignItems:'center',justifyContent:'center'}}>
                        ...
                        <TouchableOpacity style={{
                            ...
                            <Text style={{fontSize: setSpText(16), color: '#fff'}}>添加</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{
                            width:200,
                            height:50,
                            ...
                            <Text style={{fontSize: setSpText(16), color: '#fff'}}>关闭</Text>
                        </TouchableOpacity>
                    </View>
                </Modal>
            </View>
