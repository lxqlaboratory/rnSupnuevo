...
class Demo extends Component {
    ...
    render() {
        let dropdown_6_icon = this.state.dropdown_6_icon_heart ? require('../img/google_calendar.png') : require('../img/drivingService.png');
        return (
    ...
    _dropdown_2_renderRow(rowData, rowID, highlighted) {
        let icon = highlighted ? require('../img/google_calendar.png') : require('../img/drivingService.png');
        let evenRow = rowID % 2;
        return (
