            ...
            <View>
                <TouchableOpacity onPress={
                    ...
                    justifyContent:'flex-start',backgroundColor:'#fff'}}>
                        <Text style={{flex:1,fontSize:setSpText(16),color:'#343434'}}>{rowData.codigo}</Text>
                        <Text style={{flex:2,fontSize:setSpText(16),color:'#343434',marginLeft:20}}>{rowData.nombre}</Text>
                    </View>
        ...
        return (
            <View style={{flex:1}}>
                ...
                <View>
                    ...
                    justifyContent:'flex-start',backgroundColor:'#fff'}}>
                            <Text style={{flex:2,fontSize:setSpText(16),color:'#343434'}}>编号</Text>
                            <Text style={{flex:3,fontSize:setSpText(16),color:'#343434'}}>名称</Text>
                        </View>
                        <View style={{flex:1}}>
                            {listView}
                        </View>
