            ...
            case 0:
                colorText =
                    <View style={{
                        ...
                        <Text style={{flex: 1, fontSize: setSpText(16), color: '#343434'}}>{rowData.groupNum}</Text>
                        <Text style={{flex: 2, fontSize: setSpText(16), color: '#343434'}}>{rowData.groupName}</Text>
                    </View>
                break;
            case 1:
                colorText =
                ...
                <View>
                    <ScrollView>
                        <View style={{
                            ...
                            <Text style={{flex: 1, fontSize: setSpText(16), color: '#343434'}}>组编号</Text>
                            <Text style={{flex: 2, fontSize: setSpText(16), color: '#343434'}}>组名称</Text>
                        </View>
                        <View style={{flex: 1}}>
                            {listView}
                        </View>
