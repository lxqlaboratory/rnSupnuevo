    ...
    fetchData() {
        ...
        proxy.postes({
            ...
            if (errorMsg !== null && errorMsg !== undefined && errorMsg !== "") {
                ...
                this.setState({infoList: infoList,arrlong: arrlong});
            }
        }).catch((err)=>{alert(err);});
    }
            ...
            <View>
                <TouchableOpacity onPress={() => {this.navigateBigpic(rowData.attachId)}}>
                    ...
                    marginTop:50,marginRight:15,
                        ...
                        <Image resizeMode="contain" style={{width:65,height:65}}
                    ...
                    <View style={{padding:10}}>
                        <Text style={{fontSize:setSpText(15)}}>
                            价格:{rowData.precio}
                        </Text>
                    </View>
                </TouchableOpacity>
                ...
                <View style={{flex: 1}}>
                        ...
                        <View style={{flex: 1, flexDirection: 'row', borderWidth: 1, borderColor: '#ddd'}}>
                            ...
                            <View style={{flex: 1}}>
                                <TouchableOpacity style={styles.touchOty}
                                    ...
                                    <Text style={{fontSize: setSpText(14)}}>不再关注</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.touchOty}
                                                  onPress={() => {
                                                      this.larugongyingshang()
                                                  }}>
                                    <Text style={{fontSize: setSpText(14), padding: 2}}>拉入我的供应商</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.touchOty} onPress={() => {
                                this.setState({cameraModalVisible: true})
                            }}>
                                    <Text style={{fontSize: setSpText(14)}}>扫描</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                        <View style={{flex: 1}}>
                    ...
                    <View style={{flex: 1, flexDirection: 'row'}}>
                        <TouchableOpacity style={{
                            ...
                            <View>
                                <Text style={{fontSize: setSpText(16)}}>我的供应商</Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={{
                            flex: 1,
                            ...
                            <View>
                                <Text style={{fontSize: setSpText(16)}}>我关注</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
